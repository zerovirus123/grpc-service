...
var file_greet_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x65, 0x74, 0x22, 0x25, 0x0a, 0x0f, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67,
...
var file_greet_proto_goTypes = []interface{}{
	(*GreetingRequest)(nil),  // 0: greet.GreetingRequest
	(*GreetingResponse)(nil), // 1: greet.GreetingResponse
}
var file_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetService.Greeting:input_type -> greet.GreetingRequest
	1, // 1: greet.GreetService.Greeting:output_type -> greet.GreetingResponse
